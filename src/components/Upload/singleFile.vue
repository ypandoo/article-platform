<template>
	<div class="upload-container">
		<el-upload class="image-uploader" :data="dataObj" drag :multiple="false" :show-file-list="false" action="http://up-z2.qiniup.com/"
		...
		<div class="image-preview image-app-preview">
			<div class="image-preview-wrapper" v-show="imageUrl.length>1">
				<img :src="'http://imgjz.cslasa.cn/file%20%281%29.png'" style="width: 100px;
    height: 100px;
    left: 50%;
    position: relative;
    margin-left: -50px;
